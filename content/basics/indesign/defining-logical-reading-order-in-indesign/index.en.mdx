...
<NoteMessage>
More about <a href="https://helpx.adobe.com/indesign/using/threading-text.html">threading text</a> you can read in Adobe’s online manual.
</NoteMessage>
...
<NoteMessage>
More about <a href="https://helpx.adobe.com/indesign/using/anchored-objects.html">anchored objects</a> you can read in Adobe’s online manual.
</NoteMessage>

<NoteMessage>
Since images are non-text content, an alternative text must be provided if they are relevant to the content. If they are not relevant, they do not belong in an article. For further information, see also <Link to="/glossary/#alt-text">alt text</Link> in the glossary or <Link to="/basics/general/add-an-alt-text/">“Add an alt text”</Link>.
</NoteMessage>
