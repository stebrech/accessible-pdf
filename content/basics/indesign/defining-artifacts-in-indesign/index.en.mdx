...
<NoteMessage>
Any graphical shapes and strokes <strong>that do not contain alternative text</strong> are automatically marked as artifacts. For such elements, it is therefore not necessary to use the object export options.
</NoteMessage>
