...
| PDF *Tag* | Semantische Bedeutung | Mögliche und semantisch sinnvolle Elternelemente | Mögliche und semantisch sinnvolle Kindelemente |
|:--|:--|:--|:--|
| `P` | Gewöhnlicher Absatz; Englisch abgekürzt für *Paragraph* | `Document`, `Part`, `Art`, `Sect`, `Div`, `BlockQuote`, `Caption`, `TOCI` | [Inline-Elemente](#inline-elemente) |
| `H1`, `H2`, `H3`, `H4`, `H5`, `H6` | Hierarchische Überschriften der Ebene 1 bis 6; H ist die englisch Abkürzung für *Heading* | `Document`, `Part`, `Art`, `Sect`, `Div`, `BlockQuote` | [Inline-Elemente](#inline-elemente) |
