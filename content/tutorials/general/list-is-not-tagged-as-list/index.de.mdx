...
Für Menschen, die auf [AT](/de/glossary/#assistive-technologie) angewiesen sind, helfen korrekt *getaggte* Listen dem Verständnis und verbessern die Navigationsmöglichkeiten.
...
![Listen-Schaltflächen in Microsoft Word](word_list_icons.png)
...
![Listen-Schaltflächen in Adobe InDesign](indesign_list_icons.png)
...
Die benötigten *Tags* sind `<L>`, `<LI>`, `<Lbl>` und `<LBody>`. Die einzelnen *Tags* werden in [„Übersicht der *PDF-Tags*“](/de/basics/general/overview-of-the-pdf-tags/) beschrieben.