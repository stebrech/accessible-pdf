...
Der oberste `<Part>` *Tag* muss in den `<Document>` *Tag* geändert werden, siehe dazu [„PDF-Tags in Acrobat erstellen und ändern“](/de/basics/acrobat/create-and-modify-pdf-tags-in-acrobat/).