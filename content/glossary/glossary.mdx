...
A PDF is accessible if it's compatible with the <AnchorLink to="#pdfua">PDF/UA</AnchorLink> standard and follows the [WCAG](https://www.w3.org/WAI/intro/wcag) guidelines.
...
<ul>
    <li><Link to="/basics/indesign/defining-artifacts-in-indesign/">Defining artifacts in InDesign</Link></li>
    <li><Link to="/basics/word/defining-artifacts-in-word/">Defining artifacts in Word</Link></li>
    <li><Link to="/basics/acrobat/create-and-check-artifacts-in-acrobat/">Create and check artifacts in Acrobat</Link></li>
</ul>
...
see <AnchorLink to="#alt-text">alt text</AnchorLink>
...
AT is the abbreviation of <AnchorLink to="#assistive-technology">assistive Technology</AnchorLink>

## automatic testing

As the <AnchorLink to="#matterhorn">Matterhorn Protocol</AnchorLink> says there are 87 failure conditions which can be checked through software. <AnchorLink to="#pac">PAC</AnchorLink> for instance can find such kind of errors.
