...
![Grafik: Pfeile zeigen von einem InDesign-, Word- und Acrobat-Dokument zu einem barrierefreien Dokument (Logo accessible-pdf.info). Zusätzlich zeigen Pfeile den Umweg von InDesign- und Word-Dokumenten über Acrobat.](homepage-teasers_apps.png)
...
![Grafische Darstellung eines Dokument-Herstellungsprozesses mit den drei Phasen Konzeption/Design, Satz/Umsetzung, PDF-Nachbearbeitung. Darin werden die beiden Startpunkte „Vorlagenherstellung“ und „Ad hoc ab Quelldok.“ als benutzerfreundlicher und realistischer gekennzeichnet. Gewarnt wird vor „Ad hoc ab PDF“ da technischer und aufwändiger. Zudem wird auf den redaktionellen Einfluss bei der Vorlagenherstellung sowie innerhalb der Konzeptionsphase aufmerksam gemacht.](homepage-teasers_workflow-de.png)
...
![accessible-pdf.info mag creative commons (symbolisiert mit einem Herz und beiden Logos).](homepage-teasers_cc.png)
