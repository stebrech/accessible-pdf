...
post_excerpt: With this privacy policy we inform you about the processing of personal data in connection with our accessible-pdf.info website and our other online services.
layout: page
...
## 1. Contact addresses {#contact-adresses}
...
## 2. Processing of personal data {#processing}
...
### 2.3 Type, scope and purpose {#type-scope-purpose}
...
### 2.4 Processing of personal data by third parties, including abroad {#third-party}
...
## 3. Rights of affected persons {#rights}
...
### 5.2 Server log files {#log-files}
...
### 5.3 Tracking pixel {#tracking-pixel}
...
## 6. Notifications and messages {#newsletter}
...
### 6.1 Success and audience measurement {#newsletter-measurement}
...
### 6.2 Consent and objection {#newsletter-consent}
...
## 8. Third party services {#services}
...
### 8.3 Success and audience measurement {#analytics}
...
## 9. extensions for the website {#extensions}
